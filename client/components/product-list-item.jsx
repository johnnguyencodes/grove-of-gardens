...
export default function ProductListItem(props) {
  ...
  return (
    <div className="py-3 px-0 col-xl-4 col-xs-12" id={product.productId}>
      <div className="card product-list-card h-100 stretched-link card-product-list-item shadow-sm" onClick={() => props.setView('details', { productId: product.productId })}>
